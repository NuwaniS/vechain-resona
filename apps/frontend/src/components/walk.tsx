  ...
  return (
    <div style={{ position: "relative", top: "30px", height: '150px' }}>
      ...
      <Modal isOpen={isModalOpen} onClose={onModalClose}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Walking Outdoors</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <Stack spacing={4}>
              <Text fontSize="md">Log your walking points</Text>
      ...
      <Drawer isOpen={isDrawerOpen} placement="bottom" onClose={onDrawerClose}>
        ...
        <DrawerContent>
          <DrawerCloseButton />
          <DrawerHeader>Walk Status</DrawerHeader>
          <DrawerBody>
